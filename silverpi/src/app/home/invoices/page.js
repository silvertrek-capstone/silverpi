        ...
        <div className="bg-grey">
            <div className="bg-grey px-6 py-24 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h1 className="text-8xl font-bold tracking-tight text-gray-900 ">Invoices</h1>
                </div>
            </div>
                                ...
                                {invoices.map((invoices) => (
                                    <tr key={invoices.id}>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-left font-medium text-gray-900 sm:pl-6">
                                            <Link href={`/home/workorders/${invoices.id}`} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                                                {invoices.id}
                                            </Link>
                                        </td>
